   ...
   <div className="contents">
    ...
    <div className="block" id="secret-lab">
      ...
      <div className="project-description">
        ...
        <p style={{marginBlockEnd: "0"}}>Click <a href="https://youtu.be/6Eh_4aEM0Pg" target="_blank" rel="noopener">here</a> view the 4 minute game video. </p>
    ...
    {/* plane block */}
     <div className="block" id="plane">
        ...
        <div className="project-description">
          ...
          <p>Click <a href="https://github.com/meg213/blenderFiles" target="_blank" rel="noopener">here</a> to view or download the Blender file.</p>
        </div> 
     </div>
    ...
    <div className="block" id="tunnel">
      ...
      <div className="project-description">
        ...
        <p>Click <a href="https://www.figma.com/file/fCAMuaf1GMQzgupHkwO60q/App?node-id=217222%3A448" target="_blank" rel="noopener">here</a> to view the Figma file.</p>
        <p>Click <a href="https://github.com/meg213/balance_me" target="_blank" rel="noopener">here</a> to view the project files.</p>
        <p>Click <a href="https://youtu.be/IbOtIXRyzlg" target="_blank" rel="noopener">here</a> to see a demo of the application.</p>
      </div>
    </div>
      ...
      <div className="visual">
        <img src={require('../images/bdc.png')}/>
      </div>
      <div className="project-description">
        <div className="project-name"> Blue Donkey Coffee Style Guide</div>
        <p>One of my favorite coffee shops on Georgia Tech's campus is <a href="https://www.bluedonkeycoffee.com/" target="_blank" rel="noopener">Blue Donkey Coffee</a>.
          Using Adobe InDesign and Illustrator, I created a style guide that updated their logo, website, and overall company image.
        </p>
        <p>Click <a href={bdc} target="_blank" rel="noopener">here</a> to see the style guide.</p>
      </div>
    </div>
    ...
    <div className="block" id="twitterbot">
      ...
      <div className="project-description">
        ...
        <p>Click <a href="https://twitter.com/making_planets" target="_blank" rel="noopener">here</a> to see the twitter page!</p>
        <p>Click <a href="https://github.com/meg213/twitterbot" target="_blank" rel="noopener">here</a> to view or download the project files.</p>
        <p>Want even more? <a href={twitterbot} target="_blank" rel="noopener">Here's</a> the full project write up.</p>
      </div>
    </div>
    ...
    <div className="block" id="mirror">
      <div className="visual">
        <img src={require('../images/the-mirror-more.png')}/>
      </div>
      <div className="project-description">
        ...
        <p>Click <a href={comic} target="_blank" rel="noopener">here</a> to see the full comic!</p>
      </div>
    </div>
    ...
    <div className="block" id="data-vis">
      ...
      <div className="project-description">
        ...
        <p>Click <a href="https://github.com/meg213/data_visualization" target="_blank" rel="noopener">here</a> to see or download the files.</p>
        <p>Want even more? <a href={dataVis} target="_blank" rel="noopener">Here's</a> the full project write up.</p>
      </div>
    </div>
    ...
    <div className="block" id="tree">
      <div className="visual">
       <img src={require('../images/audio_art.png')}/>
      </div>
      <div className="project-description">
        <div className="project-name"> Audio Art</div>
        <p>As my first animated Blender project, this really jumpstarted my love for animation and 3D rendering!
        </p>
        <p>Click <a href="https://github.com/meg213/audio_art" target="_blank" rel="noopener">here</a> to view or download the project files.</p>
        <p>Want even more? <a href={audioArt} target="_blank" rel="noopener">Here's</a> the full project write up.</p>
      </div>
    </div>
    ...
    <div className="block" id="portfolio">
      ...
      <div className="project-description">
        ...
        <p>Click <a href="https://github.com/meg213/meg213.github.io" target="_blank" rel="noopener">here</a> to see the project files.</p>
      </div>
    </div>  
